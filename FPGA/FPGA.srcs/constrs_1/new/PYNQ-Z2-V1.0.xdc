...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { encoderA }]; #IO_L7P_T1_34 Sch=ja_p[2]
...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { encoderB }]; #IO_L22P_T3_34 Sch=ja_p[4]
