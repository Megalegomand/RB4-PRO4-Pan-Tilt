...
architecture STRUCTURE of assembly_data_controller_0_0_data_controller is
  ...
  signal \data_rx_id_reg[1]_i_6_n_0\ : STD_LOGIC;
...
\data_rx_id_reg[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"69969669"
    )
        port map (
...
\data_rx_id_reg[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\data_rx_id_reg[1]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\data_rx_id_reg[1]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
    )
        port map (
