...
entity assembly_pwm_0_0_pwm is
  port (
    o : out STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of assembly_pwm_0_0_pwm : entity is "pwm";
end assembly_pwm_0_0_pwm;

architecture STRUCTURE of assembly_pwm_0_0_pwm is
  ...
  signal \duty_cycle_t[7]_i_3_n_0\ : STD_LOGIC;
  signal \^o\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \duty_cycle_t[7]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of o_i_6 : label is "soft_lutpair2";
begin
  o <= \^o\;
...
\duty_cycle_t[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => cnt_reg(0),
      I3 => cnt_reg(1),
      I4 => \duty_cycle_t[7]_i_3_n_0\,
      I5 => rst,
      O => \duty_cycle_t[7]_i_1_n_0\
    );
\duty_cycle_t[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\duty_cycle_t[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
entity assembly_pwm_0_0 is
  ...
  attribute NotValidForBitStream of assembly_pwm_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of assembly_pwm_0_0 : entity is "assembly_pwm_0_0,pwm,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of assembly_pwm_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of assembly_pwm_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of assembly_pwm_0_0 : entity is "pwm,Vivado 2020.2";
end assembly_pwm_0_0;

architecture STRUCTURE of assembly_pwm_0_0 is
...
begin
U0: entity work.assembly_pwm_0_0_pwm
     port map (
      clk => clk,
