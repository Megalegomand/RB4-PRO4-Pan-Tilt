...
module assembly_spi_0_0(clk, rst, sclk, sdi, data_in, ss, sdo, state, data_out)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,sclk,sdi,data_in[15:0],ss,sdo,state[3:0],data_out[15:0]" */;
  input clk;
  input rst;
  input sclk;
  input sdi;
