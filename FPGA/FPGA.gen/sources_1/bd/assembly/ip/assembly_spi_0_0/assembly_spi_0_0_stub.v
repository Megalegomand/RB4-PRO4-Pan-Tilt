...
module assembly_spi_0_0(rst, sclk, ss, sdi, data_in, sdo, state, data_out)
/* synthesis syn_black_box black_box_pad_pin="rst,sclk,ss,sdi,data_in[7:0],sdo,state[3:0],data_out[7:0]" */;
  input rst;
  input sclk;
  input ss;
  input sdi;
