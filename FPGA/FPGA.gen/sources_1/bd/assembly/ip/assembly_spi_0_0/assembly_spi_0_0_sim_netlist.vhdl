...
architecture STRUCTURE of assembly_spi_0_0_spi is
  ...
  signal \data_out_t[7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \reg_cnt[2]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \data_out_t[7]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \reg_cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \reg_cnt[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \reg_cnt[2]_i_2\ : label is "soft_lutpair0";
...
\data_out_t[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\reg_cnt[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFEAA00000100"
    )
        port map (
      I0 => ss,
      I1 => sclk,
...
\reg_cnt[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000155"
    )
        port map (
